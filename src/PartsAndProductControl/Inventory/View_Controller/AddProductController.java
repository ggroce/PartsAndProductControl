...
public class AddProductController implements Initializable {
    ...
    public void saveButtonPushed(ActionEvent event) throws IOException{
        ...
        try {
            ...
            } else {                                                //Try to add product.  Will produce error if number fields not entered correctly.
                Product newProduct = new Product(inventory.assignProductId(), name, Double.parseDouble(price),
